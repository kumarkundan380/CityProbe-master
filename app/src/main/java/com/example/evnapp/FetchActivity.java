...
public class FetchActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    TextView textView_Date,textView_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_Date.setText(DateFormat.getDateInstance().format(Calendar.getInstance().getTime()));
    }
    ...
    public void showData()
    {
        ...
        date_info = textView_Date.getText().toString().trim();
